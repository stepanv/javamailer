...
public class MonitorPanel extends JPanel {
    ...
    private void createAndShow() {
        GridBagConstraints gbc_tabbedPaneMonitor_1 = new GridBagConstraints();
        gbc_tabbedPaneMonitor_1.insets = new Insets(0, 0, 5, 0);
        gbc_tabbedPaneMonitor_1.fill = GridBagConstraints.BOTH;
        gbc_tabbedPaneMonitor_1.gridx = 0;
        gbc_tabbedPaneMonitor_1.gridy = 2;
        this.add(tabbedPaneMonitor, gbc_tabbedPaneMonitor_1);
        
        GridBagLayout gridBagLayout = new GridBagLayout();
        gridBagLayout.columnWidths = new int[]{421, 0};
        gridBagLayout.rowHeights = new int[]{105, 0};
        gridBagLayout.columnWeights = new double[]{0.0, Double.MIN_VALUE};
        gridBagLayout.rowWeights = new double[]{0.0, Double.MIN_VALUE};
        setLayout(gridBagLayout);
        tabbedPaneMonitor.setBorder(new TitledBorder(null, "Monitor", TitledBorder.LEADING,
